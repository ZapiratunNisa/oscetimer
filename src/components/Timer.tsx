      ...
      <div className="text-center space-y-4">
        ...
        <div className="relative mb-6">
          ...
          <div className="mt-4 bg-muted rounded-full h-2 overflow-hidden">
            <div className="h-full bg-gradient-primary transition-all duration-1000 ease-out" style={{
            width: `${progress}%`
          }} />
          </div>
        </div>
        ...
        {/* Audio Controls */}
        {isAudioSupported && <div className="bg-accent/20 rounded-lg p-4 border border-accent space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={isTickEnabled} onCheckedChange={setIsTickEnabled} />
            </div>
            
            {isTickEnabled && <div className="space-y-2">
                <div className="flex items-center justify-between">
                ...
                <Slider value={[tickVolume]} onValueChange={value => setTickVolume(value[0])} min={0} max={1} step={0.1} className="w-full" />
              </div>}
        ...
        {isCompleted && <div className="text-destructive text-2xl font-bold animate-pulse-glow bg-destructive/10 p-4 rounded-lg border border-destructive">
            🚨 WAKTU HABIS! ⏰
          </div>}
      </div>
    </Card>;
